...
describe("TP 3 - Empleados", () => {
    ...
    it("`empleadesQueSabenLenguajes`, que tome por parámetro un array de lenguajes y devuelva un array con aquelles empleades que sepan al menos uno de esos lenguajes)", () => {

        const lenguajesRequeridos = ["Ruby", "Java", "Python"]


        expect(empleadesQueSabenLenguajes(empleadesTest, lenguajesRequeridos)).to.be.eql([empleadesTest[1], empleadesTest[2]])
    ...
    it("`obtenerTitulosCompletos` ej17, que devuelva un array donde cada elemento es un string con la forma 'nombre, puesto seniority, area', p.ej.: 'Nadia Conrad, Senior Backend Developer, Desarrollo', habiendo un elemento por cada empleade(usar map)", () => {


        expect(obtenerTitulosCompletos(empleadesTest, lenguajesRequeridos)).to.be.eql([empleadesTest[1], empleadesTest[2]])
