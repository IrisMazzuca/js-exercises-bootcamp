...
const libros = librosDeJS.reduce((acumuladorTitulo, tituloActual) => {
  let coleccionTitulos = "";
  coleccionTitulos = acumuladorTitulo + "<li>" + tituloActual + "</li>";
  return coleccionTitulos;
}, "<ul>");

console.log(libros, "</ul>");
